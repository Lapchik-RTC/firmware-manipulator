...
//         d = readInt();
//         printData(d);
//         if(abs(tag_y_const - d.zahvat_y) < 95 && d.zahvat_y != 0) {
//           servo.write(150);
...
//       d = readInt();
//       printData(d);
//       if (abs(d.zahvat_x - pole_x_const) > 5 && d.zahvat_x != 0) {
//         shag_x(d.zahvat_x, (pole_x_const));
//         Serial.println("X");

//       }
//       if ((abs(pole_y_const - d.zahvat_y) > 10 && d.zahvat_y != 0) || abs(d.zahvat_x - pole_x_const) > 5) {
