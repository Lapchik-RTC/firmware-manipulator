...
while True:
    ...
    for blob in img.find_blobs([(10, 97, 14, 113, 13, 115)], area_threshold=300, pixels_threshold=90, merge=True, margin=100):
    ...
    for blob1 in img.find_blobs([(10, 97, -128, -19, 5, 127)], area_threshold=100, pixels_threshold=30, merge=True, margin=40):
